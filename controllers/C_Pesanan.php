...
class C_Pesanan extends Controller
{
	...
	public function tambah()
	{
		...
		$data_perjalanan = $this->perjalanan->lihat_id($this->req->post('id_perjalanan'));
		$perjalanan = $data_perjalanan->fetch_object();

		$data_mobil = $this->mobil->lihat_id($this->req->post('id_mobil'));
		$mobil = $data_mobil->fetch_object();

		$harga = $mobil->hargasewa * $perjalanan->jarak;
	...
	public function kembali($id)
	{
		...
		$this->view('pesanan/kembali', $data);
	}
