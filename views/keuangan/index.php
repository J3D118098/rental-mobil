				...
				<div class="row">
					<div class="col-sm-4">
						<div class="card shadow">
							...
							<div class="card-body">
								<form method="POST" action="<?= base_url('keuangan/tambah') ?>" enctype="multipart/form-data">
					...
					<div class="col-sm-8">
						<div class="card shadow">
							<div class="card-header">
								<h6 class="m-0 font-weight-bold text-primary">Catatan Pengeluaran</h6>
							</div>
							<div class="card-body">
								...
								<table class="table table-bordered" id="dataTable" width="" cellspacing="0">
	                 				...
	                 				<tbody>
										<?php while($keuangan = $data_keuangan->fetch_object()) : ?>
											<tr>
												<td><?= $no++ ?></td>
												<td><?= $keuangan->nama_mobil ?></td>
												<td><?= $keuangan->keperluan ?></td>
												<td><?= $keuangan->harga ?></td>
												<td>
													<a href="<?= base_url('rugi/ubah/' . $rugi->id) ?>" class="btn btn-sm btn-info mb-2"><i class="fa fa-pen"></i> Ubah</a><br>
													<a href="<?= base_url('rugi/detail/' . $rugi->id) ?>" class="btn btn-sm btn-warning mb-2"><i class="fa fa-eye"></i> Detail</a><br>
	                 								<a href="<?= base_url('rugi/hapus/' . $rugi->id) ?>" class="btn btn-sm btn-danger" onclick="return confirm('apakah anda yakin?')"><i class="fa fa-trash"></i> Hapus</a>
												</td>
											</tr>
										<?php endwhile; ?>
									</tbody>
