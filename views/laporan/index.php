			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="row">
						...
						$transaksi = mysqli_query($kon, "SELECT DISTINCT MONTH(tgl_pinjam) as bulan FROM tbl_pesanan");
						while ($dataTransaksi = mysqli_fetch_assoc($transaksi)) {
							$transaksi_axis[] = date("F", mktime(0, 0, 0, $dataTransaksi['bulan'], 10));
							$count = mysqli_query($kon, "SELECT COUNT(id) FROM tbl_pesanan WHERE MONTH(tgl_pinjam)='" . $dataTransaksi['bulan'] . "'");
							while ($dataCount = mysqli_fetch_assoc($count)) {
								$count_axis[] = $dataCount['COUNT(id)'];
							}
						}
						?>
						<div class="main-content">
							<div class="section_content section_content--p30">
								<div class="container-fluid">
									<div class="row">
										<h3 class="title-3 m-b-30">Transaksi / Bulan</h3>
										...
										<script>
											...
											var myChart = new Chart(ctx, {
												type: 'bar',
												data: {
													labels: <?php echo json_encode($transaksi_axis); ?>,
													datasets: [{
														label: 'Jumlah Transaksi (Rp/Bulan)',
