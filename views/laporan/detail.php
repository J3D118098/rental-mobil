					...
					<div class="col-md-6">
						<div class="card shadow">
							...
							<div class="card-body">
								...
								<div class="row">
									<div class="col">
										<a href="<?= base_url('rugi/ubah/' . $pemesan->id) ?>" class="btn btn-sm btn-info"><i class="fa fa-pen"></i> Ubah</a>
         								<a href="<?= base_url('rugi/hapus/' . $pemesan->id) ?>" class="btn btn-sm btn-danger" onclick="return confirm('apakah anda yakin?')"><i class="fa fa-trash"></i> Hapus</a>
										<a href="<?= base_url('rugi') ?>" class="btn btn-sm btn-secondary"><i class="fa fa-reply"></i> Kembali</a>
									</div>
								</div>
							</div>
						</div>
