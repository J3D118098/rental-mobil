					...
					<div class="row">
						...
						<div class="col-sm-8">
							<div class="card shadow">
								...
								<a href="<?= base_url('index/cetak') ?>" class="btn btn-sm btn-warning"><i class="fa fa-file-pdf"></i> PDF</a>
								<div class="card-body">
												...
												<tr>
													...
													<td>
														...
														<?php if ($pesanan->status == 0) { ?>
															<a href="<?= base_url('pesanan/kembali/' . $pesanan->id) ?>" class="btn btn-sm btn-success mb-2"><i class="fa fa-check"></i> Kembali</a><br>
														<?php } ?>
									...
									<a class="nav-link" href="<?= base_url('pesanan/cetak') ?>">
										<i class="fas fa-fw fa-printer"></i>
										<span>Cetak</span>
									</a>
								</div>
							</div>
